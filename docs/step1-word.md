...
캘리버 변환 시 아래 요소들이 **모두 잘 살아남는 것**을 확인했습니다.

| 디자인 요소 | 변환 결과 |
|-----------|---------|
| 1x1 테이블 박스 (배경색 + 테두리) | ✅ 완벽 보존 |
| 3열 비교 테이블 (헤더 배경색 포함) | ✅ 완벽 보존 |
| 인용문 (왼쪽 두꺼운 테두리 + 연한 배경) | ✅ 완벽 보존 |
| 강조 배너 (진한 배경 + 흰 글씨) | ✅ 완벽 보존 |
| 이미지 + 캡션 | ✅ 완벽 보존 |
| 글자 색상, 볼드, 이탤릭 | ✅ 완벽 보존 |
