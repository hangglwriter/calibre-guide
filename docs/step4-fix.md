...
## 4-2. 필수 수정: class="calibre" 제거

<div class="warning-box">
⚠️ <b>이 단계를 건너뛰면 서점에서 등록이 거부됩니다!</b>
</div>
...
4. 선택한 폴더 안에 **저자명** 폴더가 생깁니다

![저장된 폴더 - 저자명으로 폴더 생성](images/step4-saved-folder.png)

5. 저자명 폴더 → 책제목 폴더 안에 EPUB 파일이 있습니다

![폴더 안의 EPUB 파일](images/step4-saved-files.png)

6. EPUB 파일을 원하는 위치로 복사하고, **파일명을 책 제목으로 변경**
